                    ...
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="roll_number" id="roll_number" value="{{ old('roll_number') }}" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('roll_number') border-red-500 @enderror" 
                                required>
                            @error('roll_number')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            <label for="program" class="block text-gray-700 text-sm font-bold mb-2">Academic Program</label>
                            <input type="text" name="program" id="program" value="{{ old('program') }}" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('program') border-red-500 @enderror" 
                                required>
                            @error('program')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
